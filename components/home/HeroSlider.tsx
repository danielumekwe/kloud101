      ...
      >
          ...
          <div className="max-w-7xl mx-auto w-full px-8 py-16">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <h1 className="fade-up-2 text-6xl font-bold text-white mb-6 leading-[1.08] tracking-tight">
                  {slide.title}
                </h1>

                {/* Description — text-xl matching original */}
                <p className="fade-up-3 text-gray-400 text-xl leading-relaxed mb-8 max-w-lg">
                  {slide.description}
                </p>
                ...
                <div className="fade-up-5 flex flex-wrap gap-4">
                  ...
                  <button className="inline-flex items-center gap-2 border border-gray-700 hover:border-gray-500 px-6 py-3 rounded-lg text-white font-semibold transition-all duration-200 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30">
                    Learn More
                  </button>
                </div>
              </div>
        ...
        <div className="relative border-t border-white/[0.06]">
          <div className="max-w-7xl mx-auto px-8 py-5 flex items-center gap-5">
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-medium uppercase tracking-wider truncate transition-colors duration-200 hidden sm:block ${
                      i === current ? "text-blue-400" : "text-gray-600 group-hover:text-gray-400"
                    }`}
                  >
                    {s.badge}
                  </span>
            ...
            {/* Counter */}
            <div className="flex-shrink-0 text-sm font-mono text-gray-500 tabular-nums">
            ...
            <button
              ...
              className="flex-shrink-0 w-9 h-9 rounded-lg border border-gray-700 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
            >
              {paused ? (
