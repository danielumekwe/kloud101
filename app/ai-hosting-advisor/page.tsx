...
export default function AIHostingAdvisorPage() {
  ...
  const inputCls =
    "w-full rounded-xl bg-slate-900/80 border border-slate-700/60 px-4 py-3.5 text-white placeholder-slate-500 outline-none focus:border-blue-500/70 focus:ring-1 focus:ring-blue-500/30 transition-all duration-200";
  const selectCls =
    "w-full rounded-xl bg-slate-900/80 border border-slate-700/60 px-4 py-3.5 text-white outline-none focus:border-blue-500/70 focus:ring-1 focus:ring-blue-500/30 transition-all duration-200 cursor-pointer appearance-none";
    ...
    <>
      ...
      <main className="min-h-screen bg-[#020510] text-white overflow-x-hidden">
        ...
        <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
          ...
          {/* Background layers */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#020510] via-[#050d1f] to-[#020510]" />
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 py-32 text-center">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium tracking-wide mb-8 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-slate-800/60 hover:bg-slate-700/60 border border-slate-700/60 text-white font-semibold text-base transition-all duration-200 backdrop-blur-sm"
              >
            ...
            <div className="relative mx-auto max-w-sm w-full px-2 sm:px-0">
              ...
              <div className="relative bg-slate-900/90 border border-slate-700/60 rounded-2xl p-5 backdrop-blur-xl text-left">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-24 h-1.5 bg-slate-800 rounded-full overflow-hidden">
                      <div className="h-full w-[98%] bg-gradient-to-r from-blue-500 to-indigo-400 rounded-full" />
                    </div>
                    <span className="text-blue-400 text-xs font-bold">98%</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Bottom fade */}
          <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#020510] to-transparent pointer-events-none" />
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={m.stat} className="text-center group">
                  ...
                  <h3 className="text-3xl font-black text-blue-400 group-hover:text-blue-300 transition-colors">
                    {m.stat}
                  </h3>
        ...
        <section id="assessment" className="py-24">
          <div className="max-w-3xl mx-auto px-6">
                    ...
                    >
                      ...
                      <span
                        className={`text-[11px] font-medium hidden sm:block transition-colors ${
                          currentStep >= step.id ? "text-blue-400" : "text-slate-600"
                        }`}
                      >
                        {step.title}
                      </span>
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-900/70 border border-slate-800/80 rounded-3xl p-5 sm:p-10 backdrop-blur-xl">

                {/* Step 1 — About You */}
                {currentStep === 1 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                      <p className="text-blue-400 text-sm font-semibold uppercase tracking-widest mb-1">Step 1</p>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">Current Hosting Provider</label>
                      <input
                        type="text"
                ...
                {currentStep === 2 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                      <p className="text-blue-400 text-sm font-semibold uppercase tracking-widest mb-1">Step 2</p>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-3">Expected Monthly Visitors</label>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                ...
                {currentStep === 3 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                      <p className="text-blue-400 text-sm font-semibold uppercase tracking-widest mb-1">Step 3</p>
                      <h3 className="text-2xl font-bold mb-6">Infrastructure Requirements</h3>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-3">Storage Priority</label>
                      <div className="grid gap-3">
                        {[
                          ...
                          >
                            ...
                            <div>
                              <p className="font-semibold text-sm text-white">{opt.value}</p>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-3">Security Requirement</label>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {[
                          { value: "Basic Protection", color: "text-slate-400" },
                          { value: "Business Security", color: "text-blue-400" },
                ...
                {currentStep === 4 && (
                  <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                    <div>
                      <p className="text-blue-400 text-sm font-semibold uppercase tracking-widest mb-1">Step 4</p>
                      <h3 className="text-2xl font-bold mb-6">Final Preferences</h3>
                    </div>

                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-3">Do you need cPanel?</label>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-3">Daily Backups Required?</label>
                      <div className="grid grid-cols-2 gap-3">
                        {["Yes", "No"].map((v) => (
                          <button
                            key={v}
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-300 mb-2">Preferred Datacenter Location</label>
                      <div className="relative">
                        <select
                ...
                <div className="flex items-center justify-between mt-10 pt-6 border-t border-slate-800/60">
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-800/60 border border-slate-700/60 text-slate-400 font-medium text-sm disabled:opacity-30 disabled:cursor-not-allowed hover:text-white hover:border-slate-600 transition-all"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  {currentStep < totalSteps ? (
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-8 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-sm transition-all duration-200 hover:shadow-[0_0_30px_rgba(37,99,235,0.5)]"
                    >
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <section ref={resultsRef} className="pb-32">
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="relative mb-8">
                ...
                <div className="relative bg-slate-900/70 border border-slate-800/80 rounded-3xl p-8 backdrop-blur-xl">
                  <h3 className="text-lg font-bold text-slate-300 mb-6">Infrastructure Score</h3>
              ...
              <div className="relative mb-8">
                ...
                <div className="relative bg-slate-900/70 border border-blue-500/20 rounded-3xl p-8 backdrop-blur-xl">
                  <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20">
                      <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse" />
                      <span className="text-blue-400 text-xs font-semibold">AI Selected</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                    {[
                      ...
                      <div
                        key={s.label}
                        className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/40 hover:border-blue-500/30 transition-colors"
                      >
              ...
              {/* Software stack */}
              <div className="relative mb-8">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-slate-800/30 to-transparent rounded-3xl blur-sm" />
                <div className="relative bg-slate-900/70 border border-slate-800/80 rounded-3xl p-8 backdrop-blur-xl">
                  <h3 className="text-lg font-bold text-slate-300 mb-6">Recommended Software Stack</h3>
                  <div className="flex flex-wrap gap-3">
                    {recommendation.stack.map((item) => (
                      <div
                        key={item}
                        className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-300 text-sm font-medium hover:bg-blue-500/15 hover:border-blue-400/30 transition-all duration-200"
                      >
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-8">
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-slate-900/70 border border-slate-800/80 rounded-3xl p-6 backdrop-blur-xl h-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-3 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-base transition-all duration-200 hover:shadow-[0_0_40px_rgba(37,99,235,0.4)] group"
                >
                ...
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-3 py-4 rounded-xl bg-slate-800/60 hover:bg-slate-700/60 border border-slate-700/60 text-white font-bold text-base transition-all duration-200 backdrop-blur-sm"
                >
